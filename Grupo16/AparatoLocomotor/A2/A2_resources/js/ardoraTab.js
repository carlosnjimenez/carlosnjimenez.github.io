...
$(".txtCell").mouseenter(function () {
$(this).css("-webkit-box-shadow", " 0px 0px 0px rgba(50, 50, 50, 0.5)");$(this).css("box-shadow", "0px 0px 0px rgba(50, 50, 50, 0.5)");
}).mouseleave(function () {
$(this).css("-webkit-box-shadow", " 4px 4px 4px rgba(50, 50, 50, 0.5)"); $(this).css("box-shadow", "4px 4px 4px rgba(50,50,50,0.5)");
})
.mousedown(function () {if (typeGame != 99) {isCorrect($(this));}});
initAct();
paintButtons();
})
...
function showMessage(typeMessage){ var oldTypeGame=typeGame;typeGame=99;isShowMessage=true; if (typeMessage=="Ok"){ var textMessage=messageOk; var urlMessage=urlOk; var goURLTarget= goURLOk; var borderColor=borderOk; $("#ardoraActSel").unbind();}
if (typeMessage == "scoMessage") {var textMessage = scoMessage; var urlMessage = "";var goURLTarget = "";var borderColor = borderAttempts;$("#ardoraActSel").unbind();}
...
if ($(".txtCell_txt").length !=0) { $(".txtCell_txt").css("background-color","rgba("+hexToRgb(colorBack).r+","+hexToRgb(colorBack).g+","+hexToRgb(colorBack).b+",1)");}
